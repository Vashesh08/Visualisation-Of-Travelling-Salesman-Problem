...
def next_pg():
    if s.get()!=0:
        ...
        label3 = Label(root,text="Please select the number of cities", font=("Calibri 10 bold"), bg="orange" )
...
#HEADING
Label(text="TRAVELLING SALESMEN PROBLEM", font=("Lucida 20 bold underline"), bg="orange", pady=20).pack()

#Entering Number of Cities
l1=Label(text="Enter number of cities: ", bg="orange", font=("Times 12 bold"))
l1.place(x=50, y=100)
...
c=200
for m in range(6):
    label1 = Label(root,text=f"Enter City {m+1}", font=("Calibri 10 bold"), bg="orange" )
